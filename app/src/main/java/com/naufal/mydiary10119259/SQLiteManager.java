...
//        switch (oldVersion) {
//            case 1:
//                sqLiteDatabase.execSQL("ALTER TABLE_" + TABLE_NAME + " ADD COLUMN " + NEW_COLUMN + " TEXT");
//            case 2:
//                sqLiteDatabase.execSQL("ALTER TABLE_" + TABLE_NAME + " ADD COLUMN " + NEW_COLUMN + " TEXT");
//        }
    }

    public void addNoteToDatabase(NewNote note){
        ...
        try (Cursor result = sqLiteDatabase.rawQuery("SELECT * FROM " + TABLE_NAME, null)) {
            if(result.getCount() != 0)
            {
                while(result.moveToNext()) {
                    ...
                    NewNote note = new NewNote(id,title,desc,deleted);
                    NewNote.noteArrayList.add(note);
                }
            }
        }
    ...
    public void updateNoteInDB(NewNote note){
        SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
